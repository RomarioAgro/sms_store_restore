...
def main() -> int:
    ...
    parser.add_argument("--base-url", default=os.getenv("SMS_STORE_URL", "http://127.0.0.1:8000"))
    ...
    status, items = http_json("GET", f"{base_url}/messages?{query}", args.token)
    ...
    if args.delete:
        ...
        for item in imported:
            ...
            status, payload = http_json("DELETE", f"{base_url}/messages?{delete_query}", args.token)
